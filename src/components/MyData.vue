<template>
	<div class="Mydata">
		<div style="display: flex; flex-direction: column; justify-content: center; align-items: center;width: 98%; ">
			<h3>基本信息</h3>
			<article style="margin: 40px 0; width: 900px;">
				<el-table :data="tableData" stripe border style="width: 95%; margin: 0 10px;">
					<el-table-column prop="userId" label="ID" width="80" />
					<el-table-column prop="youName" label="姓名" />
		...
		<div style="display: flex; flex-direction: column; align-items: center;" v-if="complete !== 'yes'">
		...
		<div style="display: flex; flex-direction: column; align-items: center;" v-if="complete === 'yes'">
			...
			<el-card class="box-card">
				...
				<el-button type="primary" @click="apply(radio)">申请</el-button>
			</el-card>
		</div>
	</div>
</template>
